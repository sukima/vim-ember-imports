...
let g:vim_ember_import_definitions = {
      ...
      \   'isBlank': {'default': v:false, 'from': '@ember/test'},
      \   'isEmpty': {'default': v:false, 'from': '@ember/test'},
      \   'isEqual': {'default': v:false, 'from': '@ember/test'},
      \   'isNone': {'default': v:false, 'from': '@ember/test'},
      \   'isPresent': {'default': v:false, 'from': '@ember/test'},
      \   'tryInvoke': {'default': v:false, 'from': '@ember/test'},
      \   'typeOf': {'default': v:false, 'from': '@ember/test'},
